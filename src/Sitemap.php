<?php
namespace EnvyTek\Sitemap;

use EnvyTek\Sitemap\Writer\DeflateWriter;
use EnvyTek\Sitemap\Writer\PlainFileWriter;
use EnvyTek\Sitemap\Writer\TempFileGZIPWriter;
use EnvyTek\Sitemap\Writer\WriterInterface;
use XMLWriter;
